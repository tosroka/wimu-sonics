...
blacklist = [base_file] + [
    "bit_crush_10_results.csv",
    "vibrato_16_001_results.csv",
    "speed_120percent_results.csv",
    "time_mask_15percent_results.csv",
]
folder = "./results"
...
all_augments = sorted(
    differences.keys(), key=cmp_to_key(cmp_with_numbers), reverse=True
)
